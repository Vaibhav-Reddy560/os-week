...
// 'gsap.registerPlugin' line removed
...
export interface DotGridProps {
  ...
  maxSpeed?: number;
  resistance?: number; // This prop is no longer used, but safe to leave
      ...
      for (const dot of dotsRef.current) {
        ...
        if (speed > speedTrigger && dist < proximity && !dot._inertiaApplied) {
          ...
          gsap.to(dot, {
            xOffset: pushX,
            yOffset: pushY,
            duration: 0.1, // Short push animation
            onComplete: () => {
              gsap.to(dot, {
                xOffset: 0,
                yOffset: 0,
